  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ position: "relative", fontSize: 12, opacity: 0.6 }}>
          © {new Date().getFullYear()} AI Calls Analytics · Дипломный проект
        </Typography>
      </Box>
        ...
        <Box sx={{ width: "100%", maxWidth: 420 }} className="fade-in-up">
          ...
          >
            <TextField
              ...
              helperText="Международный формат: + и цифры, без пробелов"
            />
            <TextField
              label="Пароль"
              type="password"
